...
$plugin->version   = 2025110109;               // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release   = '1.0.33';                 // FIX: Use moodleform class instead of raw HTML (matches all other forms in plugin).
